...
public class TestController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/product_string/{name}")
	public ResponseEntity<String> getdataOnString(@PathVariable("name") String data) {
		...
		ResponseEntity<String> a = new ResponseEntity<String>(o.getProductName()+""+o.getProductCode()+""+o.getProductQuantity(), HttpStatus.OK);
		return a;
